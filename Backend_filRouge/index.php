...
$pages=['Read-px','change-ty' ,'Login-u','Logout-u','Read-rv','Update-rv','Delete-rv','Partenaire-rv','Produit-rv','Update-cmd','Add-py','Read-py','Read-bn'];
    if(isset($_GET['page']) !== null ){
        if (isset($_GET['page'])) {
            if (in_array($_GET['page'], $pages)) {
                ...
                if ($page=="Read-rv"){
                ...
                else if ($page=="Read-px"){
                    $result_rv=array();
                    $data = new paiment_rv();
                    $result_rv=$data->getAll_pr();
                    $result['prix']=$result_rv;
                }
                    ...
                    else if ($page=="change-ty"){
                        $delete_rv=new paiment_rv();
                        $result_rv=$delete_rv->Edit_ty();
                        if($result_rv){
                            $result['message']="successfully Add this r_v";
                        }else{
                            $result['error']=true;
