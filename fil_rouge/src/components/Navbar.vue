...
<div class="all" >
  ...
  <div id="side-menu" class="side-nav" :class="{sidenavopen: opened}">
    <router-link to="/home"><FAIFatma :icon="['fas' ,'house']" class="icon alt" /><span class="mobile">Acceuil</span></router-link>
    <router-link to="/Partenaire"><FAIFatma   :icon="['fas' ,'users']" class="icon alt" /> <span class="mobile">Partenaires</span></router-link>
    <router-link to="/Suivi"><FAIFatma   :icon="['fas' ,'arrow-trend-up']" class="icon alt" /> <span class="mobile">Suivi Paiment</span></router-link>
