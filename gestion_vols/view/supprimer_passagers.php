...
<body>
<div class="modal fade" id="supp_p<?php echo $fetch['id_passager'];?>" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="#">
				<h3 class="modal-title">Supprimer un passager</h3>
				<div class="modal-body">
						<div class="modal-footer">
                            <input type="hidden" name='id_passager' value="<?php echo $fetch['id_passager'];?>">
							<button name="supp" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>
							Supprimer</button>
